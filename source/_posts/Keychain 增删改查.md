...
//    [saveQueryDic setObject:[NSKeyedArchiver archivedDataWithRootObject:aData] forKey:(id)kSecValueData];
    [saveQueryDic setObject:[NSKeyedArchiver archivedDataWithRootObject:aData requiringSecureCoding:NO error:nil] forKey:(id)kSecValueData];
    // 添加数据
...
[参考资料](https://blog.csdn.net/weixin_39750598/article/details/111727219)